    ...
    public static void populateDatabase(Context context) {
        Executors.newSingleThreadExecutor().execute(() -> {
            ...
            if (db.bookDao().getBookCount() == 0) {
                ...
                b3.setDescription("Дистопический роман о тоталитарном обществе. гврпр 8рав9шрва98р п8авр89варапв89р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р р8апв9варп89вапрва89рпв8р 89вар89арвп089варп");
